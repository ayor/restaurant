...
namespace Infrastructure.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<Response<AuthResponse>> AuthenticateAsync(AuthRequest request, string ipAddress)
        {
            ...
            return new Response<AuthResponse>(response, $"Authenticated {user.FirstName}");
        }
